    ...
    public class NetworkSetup : MonoBehaviour
    {
        ...
        public static bool BuildGame()
        {
            ...
            buildPlayerOptions.scenes = EditorBuildSettings.scenes
                ...
                .Select(s => s.path)
                .ToArray();
            buildPlayerOptions.locationPathName = Path.Combine("Builds", "LuckyMultiplayer.exe");
        ...
        public static void Launch2()
        {
            ...
            Run("Builds\\LuckyMultiplayer.exe", "");
        }
        ...
        public static void CloseAll()
        {
            ...
            Process[] processes = Process.GetProcessesByName("LuckyMultiplayer");
